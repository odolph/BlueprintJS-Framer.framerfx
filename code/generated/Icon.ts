...
export type Controls = {
  ...
  htmlTitle: ControlDescription;
  icon: ControlDescription;
  iconSize: ControlDescription;
...
export const controls: Controls = {
  ...
  htmlTitle: { title: "HtmlTitle", defaultValue: "", type: ControlType.String },
  icon: {
    title: "Icon",
    options: [
      "add",
  ...
  iconSize: { title: "IconSize", type: ControlType.Number },
  tagName: {
    title: "TagName",
    options: [
      "symbol",
